...
There are many examples for this field such as
...
There are several implementations of IEC in the field of music. We will start
mentioning the pioneer application GENJAM, \cite{biles1994genjam},
...
was applied to an interactive evolutionary system for fashion design. In figure
1 we can see different user interfaces they used. Based on this approach,
another work was de-rived. Where the approach adopt a fuzzy number described
