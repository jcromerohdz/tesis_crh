...
\begin{itemize}
	\item \textbf{Creative Approach:} Artificial Life (AL) research was 
	the base of the
	creative approach. AL uses complex algorithms for biological life
	...
	as a great music and sounds, \cite{sims1991artificial}, \cite{sims1994evolving},
...
maintaining the main target of trees with an L-system. This same
L-system was the base for another experiment to create 2-D Computer Graphics (CG)
insect forms from a system called Blind Watchmaker that used 
L-system angles from intuitively selected L-system output; 
the creation was called Biomorphs. These creations reach
their target with the multiple selections of users based on their preferences;
all these selections acted like a natural adaptation filter.

We can find plenty of works and applications,  for fractal generation
...
% What is this? please add and the correct the references
%[Raynal 1999]

and \cite{lutton2003artie}, for rendering in tridimensional space,
...
It is important to mention another relevant project called Galapagos,
...
%%% The next paragraph is incomplete, please complete it or deleted
AnimationLab is a work that creates figures that can run or
walk working with the user to receive more opportunities to be picked. A
particular characteristic of all of the figures is that their extremities
...
%% Why is important to know about music generation? Is not.
...
%%% This changes the direction of the text, first we are talking about 
% work after work of IEC and then we stop at this subject??
...
%Seriously what is wrong with all this hard coded references?
