...
In the experiment EvoDrawings01 the following data are generated,  this data is 
presented in Table \ref{tab:graph_data_1}.

\begin{table}
\small
\caption{Data generated in graph based user modeling.}
\label{tab:graph_data_1} 
\centering
\small
...
\small{Relations} & \small{2220} \\ \hline  
\noalign{\smallskip}\hline
\end{tabular}
\end{table}


These data are the total of nodes and relations generated  in EvoDrawings01.


The total number of active users who participated voluntarily meners are presented in 
Table \ref{tab:graph_data_2}.

\begin{table}
\small
\caption{Total number of volunteers active users.}
\label{tab:graph_data_2} 
\centering
\small
\begin{tabular}{p{7cm} p{5cm} }
\hline\noalign{\smallskip}
 & Users\\
\noalign{\smallskip}\hline\noalign{\smallskip}
\small{Total number of users} & \small{54} \\ \hline  
\noalign{\smallskip}\hline
\end{tabular}
\end{table}
