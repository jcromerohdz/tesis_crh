...
Our motivation begins from knowing if a user model in combination with
other techniques such as usability, fuzzy logic increase the participation of users in a
given Web-based interactive evolutionary application. It is well know that one of the main
problems in these systems is fatigue, who is the cause by the large amount of individual evaluations
...
of users, in order to measure these results and to be able to demonstrate if the participation 
