...
activity by using the activity stream standard \cite{snell2014json}. %%%%% Fix reference - Mario
...
obtain a %% Fix references please - Mario difuzzify value to be used to
...
system \cite{mamdani1975experiment} \cite{mamdani1974application} as figure
\ref{fig:fis01} shown. This model was designed empirically. %% Fix references
...
high, representing the % These are not variables. Low is a linguistic variable??
