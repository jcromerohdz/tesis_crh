...
as figure \ref{fig:User-Individual} show. Each of these vertices contain
...
by set of nodes of USERS, INDIVIDUALS and COLLECTIONS. The edges are define by a set of relationships as LIKES, KNOWS, PARENT, HAS that represents the
