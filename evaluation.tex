...
Experiment ED01 generated a graph based user-model with 595 nodes and 2220
relationships.
...
This data is the total of nodes as well as their relationships. Also for this
version a total of 53 active volunteer users were generated.
...
experiments it was decided to make a relation of number user known each other
that each user have. This relation is shown in table \ref{tab:knownUsers_1}.
...
This version generated a total of 500 individual within the graph.

\begin{table}
\small
\caption{Sample of 30 individuals evaluated.}
...
This version generated 648 nodes and 2596 relationships.
%
% \begin{table}
% \small
...
% \end{tabular}
% \end{table}
Also EvoDrawings02 generated a total of 54 active users who participate voluntarily.
...
relationship that corresponds to the number of known users. The table \ref{tab:knownUsers_2}
...
\begin{table}
\small
\caption{A sample of the top 10 interconnected users.}
...
\ref{fig:weibull_2} shows the Weibull distribution, where the red dots are the adjustment of the Weibull
distribution and the black dots are the real data of the participations of the
users.
