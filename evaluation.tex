...
The experiment ED01 generated a user-model graph with the following data (Table\ref{tab:dataGenerated_1})
...
\end{tabular}
\end{table}
%% Data cannot generate things pleas correct this:
This data have generated a total of nodes as well as relationships. Also, the table
...
\end{tabular}
\end{table}
%%%% Please correct all instances of this construction
%% In figure X shows, is wrong!
